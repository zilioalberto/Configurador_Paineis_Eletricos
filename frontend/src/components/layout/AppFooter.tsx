      ...
      <div className="app-footer-inner">
        <p className="app-footer-line mb-1">
          ...
          <a
            ...
            className="app-footer-inline-link"
          >
            ZFW Engenharia
          </a>
        ...
        <div className="app-footer-actions justify-content-center">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="app-footer-ghost-btn"
          >
            LinkedIn
          </a>
          <a
            ...
            className="app-footer-ghost-btn"
          >
            <WhatsAppGlyph className="app-footer-wa-inline" />
            <span className="ms-1">{DEVELOPER.whatsappDisplay}</span>
          </a>
        </div>
      </div>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="app-footer-wa-fab"
        aria-label={`WhatsApp — ${DEVELOPER.whatsappDisplay}`}
      >
        <WhatsAppGlyph />
      </a>
    </footer>
