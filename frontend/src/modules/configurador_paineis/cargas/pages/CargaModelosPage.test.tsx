...
vi.mock('@/modules/configurador_paineis/cargas/services/cargaService', () => ({
  listarModelosCarga,
  criarModeloCarga,
...
import CargaModelosPage from '@/modules/configurador_paineis/cargas/pages/CargaModelosPage'
