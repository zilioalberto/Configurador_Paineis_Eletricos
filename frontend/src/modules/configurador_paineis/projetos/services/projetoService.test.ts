...
import {
  ...
  listarProjetos,
  obterProjeto,
} from '@/modules/configurador_paineis/projetos/services/projetoService'
import type { ProjetoFormData } from '@/modules/configurador_paineis/projetos/types/projeto'
