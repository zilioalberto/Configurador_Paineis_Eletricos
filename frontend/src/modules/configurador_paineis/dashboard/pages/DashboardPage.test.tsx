...
vi.mock('@/modules/configurador_paineis/dashboard/hooks/useDashboardResumoQuery', () => ({
  useDashboardResumoQuery: () => useDashboardResumoQueryMock(),
}))

import DashboardPage from '@/modules/configurador_paineis/dashboard/pages/DashboardPage'
