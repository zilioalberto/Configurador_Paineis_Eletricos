...
import type { CargaModelo } from '@/modules/configurador/cargas/types/carga'
...
vi.mock('@/modules/configurador/cargas/services/cargaService', () => ({
  listarModelosCarga,
  criarModeloCarga,
...
import CargaModelosPage from '@/modules/configurador/cargas/pages/CargaModelosPage'
