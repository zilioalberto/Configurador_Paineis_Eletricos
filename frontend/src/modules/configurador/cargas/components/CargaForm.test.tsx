...
import CargaForm from '@/modules/configurador/cargas/components/CargaForm'
import type { CargaFormData, TipoCarga } from '@/modules/configurador/cargas/types/carga'
import { applyTipoChange, cargaFormInitial } from '@/modules/configurador/cargas/utils/cargaFormDefaults'
