...
vi.mock('@/modules/configurador/projetos/hooks/useProjetoDetailQuery', () => ({
  useProjetoDetailQuery: () => useProjetoDetailQueryMock(),
}))

vi.mock('@/modules/configurador/cargas/hooks/useCargaListQuery', () => ({
...
vi.mock('@/modules/configurador/dimensionamento/hooks/useRecalcularDimensionamentoMutation', () => ({
...
vi.mock('@/modules/configurador/dimensionamento/components/WizardCondutoresPanel', () => ({
  default: () => null,
}))
...
import ProjetoWizardPage from '@/modules/configurador/projetos/pages/ProjetoWizardPage'
