...
vi.mock('@/modules/configurador/projetos/services/projetoService', () => ({
...
vi.mock('@/modules/configurador/projetos/hooks/useProjetoMutations', () => ({
...
import ProjetoEditPage from '@/modules/configurador/projetos/pages/ProjetoEditPage'
