...
import { useCargaListQuery } from '@/modules/configurador/cargas/hooks/useCargaListQuery'
import { useComposicaoSnapshotQuery } from '@/modules/configurador/composicao/hooks/useComposicaoSnapshotQuery'
import { useGerarSugestoesMutation } from '@/modules/configurador/composicao/hooks/useGerarSugestoesMutation'
import { useReavaliarPendenciasMutation } from '@/modules/configurador/composicao/hooks/useReavaliarPendenciasMutation'
import { DimensionamentoWizardShell } from '@/modules/configurador/dimensionamento/components/DimensionamentoWizardShell'
import WizardCondutoresPanel from '@/modules/configurador/dimensionamento/components/WizardCondutoresPanel'
import { useDimensionamentoQuery } from '@/modules/configurador/dimensionamento/hooks/useDimensionamentoQuery'
import { useRecalcularDimensionamentoMutation } from '@/modules/configurador/dimensionamento/hooks/useRecalcularDimensionamentoMutation'
