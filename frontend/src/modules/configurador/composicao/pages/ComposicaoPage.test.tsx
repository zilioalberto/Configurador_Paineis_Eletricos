...
vi.mock('@/modules/configurador/projetos/hooks/useProjetoListQuery', () => ({
  useProjetoListQuery: () => useProjetoListQueryMock(),
}))

vi.mock('@/modules/configurador/composicao/hooks/useComposicaoSnapshotQuery', () => ({
  useComposicaoSnapshotQuery: () => useComposicaoSnapshotQueryMock(),
}))

vi.mock('@/modules/configurador/dimensionamento/hooks/useDimensionamentoQuery', () => ({
...
vi.mock('@/modules/configurador/projetos/hooks/useProjetoFluxoGates', () => ({
...
vi.mock('@/modules/configurador/projetos/components/ProjetoFluxoStepper', () => ({
  ProjetoFluxoStepper: () => null,
}))

vi.mock('@/modules/configurador/composicao/hooks/useGerarSugestoesMutation', () => ({
...
vi.mock('@/modules/configurador/composicao/hooks/useReavaliarPendenciasMutation', () => ({
  useReavaliarPendenciasMutation: () => ({ mutateAsync: vi.fn(), isPending: false }),
}))

vi.mock('@/modules/configurador/composicao/hooks/useAprovarSugestaoMutation', () => ({
  useAprovarSugestaoMutation: () => ({ mutateAsync: vi.fn(), isPending: false }),
}))

vi.mock('@/modules/configurador/composicao/hooks/useReabrirComposicaoItemMutation', () => ({
  useReabrirComposicaoItemMutation: () => ({ mutateAsync: vi.fn(), isPending: false }),
}))

vi.mock('@/modules/configurador/composicao/hooks/useAlternativasSugestaoQuery', () => ({
...
vi.mock('@/modules/configurador/composicao/components/InclusaoManualCatalogoSection', () => ({
  InclusaoManualCatalogoSection: () => null,
}))

vi.mock('@/modules/configurador/composicao/services/composicaoService', () => ({
...
import ComposicaoPage from '@/modules/configurador/composicao/pages/ComposicaoPage'
