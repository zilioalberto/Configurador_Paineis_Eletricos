...
vi.mock('@/modules/configurador/composicao/hooks/useInclusaoManualMutations', () => ({
...
import { InclusaoManualCatalogoSection } from '@/modules/configurador/composicao/components/InclusaoManualCatalogoSection'
import type { InclusaoManualItem } from '@/modules/configurador/composicao/types/composicao'
