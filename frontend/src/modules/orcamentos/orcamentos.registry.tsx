/**
 * Registro de rotas e menu do app de orçamentos.
 * Mantém aliases legados de `/erp/orcamentos` por compatibilidade.
 */
...
/** Itens de menu lateral do app de orçamentos. */
export const orcamentosMenuItems: AppMenuItem[] = [
  {
    to: '/erp/cadastros',
    label: 'Cadastros',
    order: 45,
...
/** Rotas lazy-loaded do app de orçamentos e aliases legados. */
export const orcamentosRoutes: ModuleRouteConfig[] = [
  {
    path: '/erp/m/:moduleId',
