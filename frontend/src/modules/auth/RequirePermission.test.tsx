    ...
    <MemoryRouter initialEntries={['/restrito']}>
      <Routes>
        <Route
          path="/restrito"
          element={
            <RequirePermission permission="erp.ver">
...
describe('RequirePermission', () => {
  ...
  it('renderiza filhos quando usuário tem permissão', () => {
    useAuthMock.mockReturnValue({
      status: 'ready',
      user: authUser(['erp.ver']),
    })
  ...
  it('redireciona quando usuário não tem permissão', () => {
    useAuthMock.mockReturnValue({
      status: 'ready',
      user: authUser([]),
    })
