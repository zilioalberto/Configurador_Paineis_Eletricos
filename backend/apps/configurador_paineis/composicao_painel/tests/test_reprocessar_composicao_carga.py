...
from apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga import (
...
def test_reprocessar_remove_aprovados_sugestoes_e_pendencias_da_carga(
    ...
    with (
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_disjuntor_motor_para_carga"
        ) as mock_d,
        patch(
...
<<<<<<< HEAD:backend/apps/configurador_paineis/composicao_painel/tests/test_reprocessar_composicao_carga.py
        ...
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_soft_starter_para_carga"
        ) as mock_ss,
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_inversores_frequencia_para_carga"
        ) as mock_if,
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_rele_estado_solido_para_carga"
        ),
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_rele_interface_para_carga"
        ),
        patch(
            "apps.configurador_paineis.composicao_painel.services.reprocessar_composicao_carga.reprocessar_bornes_para_carga"
        ),
        patch(
