...
<<<<<<< HEAD:backend/apps/configurador_paineis/composicao_painel/services/sugestoes/fusivel.py
...
>>>>>>> origin/main:backend/composicao_painel/services/sugestoes/fusivel.py
