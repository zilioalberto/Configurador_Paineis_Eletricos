...
from apps.configurador_paineis.cargas.api.serializers import CargaModeloSerializer
...
@patch("apps.configurador_paineis.cargas.api.views.reprocessar_composicao_painel_para_carga")
