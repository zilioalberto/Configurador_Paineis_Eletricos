...
from apps.configurador_paineis.cargas.models import Carga, CargaResistencia, CargaSensor, CargaTransdutor, CargaValvula
...
def test_sensor_digital_encoder_ocupa_digital_e_rapida():
    ...
    with patch("apps.configurador_paineis.cargas.models.sensor.reset_io_flags") as reset_io, patch(
        "apps.configurador_paineis.cargas.models.sensor.save_io_flags"
    ) as save_io:
...
def test_sensor_analogico_ocupa_entrada_analogica():
    ...
    with patch("apps.configurador_paineis.cargas.models.sensor.reset_io_flags"), patch(
        "apps.configurador_paineis.cargas.models.sensor.save_io_flags"
    ):
        CargaSensor.sincronizar_quantidades_carga(sensor)
...
def test_transdutor_sincroniza_entrada_analogica():
    ...
    with patch("apps.configurador_paineis.cargas.models.transdutor.reset_io_flags"), patch(
        "apps.configurador_paineis.cargas.models.transdutor.save_io_flags"
    ):
