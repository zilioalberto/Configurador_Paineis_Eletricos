...
def importar_xml_documento_emitido(
    *,
    xml: str,
    tipo_documento: str,
    objetivo_saida: str = ObjetivoSaidaFiscalChoices.OUTRAS_SAIDAS,
    ...
    dados = _parse_por_tipo(tipo_documento, xml)
    ...
    with transaction.atomic():
        documento = DocumentoFiscalEmitido.objects.create(
            ...
            objetivo_saida=objetivo_saida or ObjetivoSaidaFiscalChoices.OUTRAS_SAIDAS,
