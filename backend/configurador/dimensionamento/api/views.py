...
from configurador.dimensionamento.api.serializers import (
...
from configurador.dimensionamento.services.circuitos.escolhas_usuario import aplicar_escolhas_condutores
