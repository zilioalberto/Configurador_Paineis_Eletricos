...
from configurador.dimensionamento.models import (
    ClassificacaoCircuitoChoices,
    DimensionamentoCircuitoAlimentacaoGeral,
    DimensionamentoCircuitoCarga,
    ResumoDimensionamento,
)
from configurador.dimensionamento.services.circuitos.dimensionar import (
...
from configurador.dimensionamento.services.circuitos.alimentacao_geral import (
    dimensionar_circuito_alimentacao_geral,
)
from configurador.dimensionamento.services.circuitos.escolhas_usuario import (
    aplicar_escolhas_condutores,
)
from configurador.dimensionamento.services.circuitos.revisao_condutores import (
    sincronizar_flag_revisao_condutores,
)
from configurador.dimensionamento.services.circuitos.validar_escolhas import (
