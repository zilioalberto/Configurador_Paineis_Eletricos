...
from configurador.cargas.models import Carga, CargaMotor, CargaResistencia
...
from configurador.dimensionamento.services.circuitos import calcular_e_salvar_circuitos_cargas
...
@patch("configurador.dimensionamento.api.views.calcular_e_salvar_dimensionamento_basico")
...
@pytest.mark.django_db
@patch("configurador.dimensionamento.api.views.registrar_evento_projeto")
@patch("configurador.dimensionamento.api.views.calcular_e_salvar_dimensionamento_basico")
