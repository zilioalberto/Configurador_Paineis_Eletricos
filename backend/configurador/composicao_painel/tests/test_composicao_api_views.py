...
from configurador.cargas.models import Carga, CargaSensor
from catalogo.models import Produto
from configurador.composicao_painel.api.views import _nome_usuario_auditoria
...
class TestComposicaoGerarSugestoesView:
    @patch("configurador.composicao_painel.api.views.gerar_sugestoes_painel")
...
class TestComposicaoReavaliarPendenciasView:
    @patch("configurador.composicao_painel.api.views.reavaliar_pendencias_projeto")
...
class TestSugestaoAlternativasView:
    @patch("configurador.composicao_painel.api.views.listar_alternativas_para_sugestao", return_value=[])
