...
from configurador.composicao_painel.models import PendenciaItem, SugestaoItem
...
def test_nucleo_corrente_total_nula_cria_pendencia(criar_projeto):
    ...
    with patch(
        "configurador.composicao_painel.services.sugestoes.seccionadoras.ResumoDimensionamento.objects.get",
...
def test_nucleo_seccionadora_sem_produto_cria_pendencia(criar_projeto):
    ...
    with patch(
        "configurador.composicao_painel.services.sugestoes.seccionadoras.selecionar_seccionadoras",
...
def test_nucleo_disjuntor_cm_sem_produto_cria_pendencia(criar_projeto):
    ...
    with patch(
        "configurador.composicao_painel.services.sugestoes.seccionadoras.selecionar_disjuntores_caixa_moldada",
        return_value=Produto.objects.none(),
    ):
        assert _nucleo_gerar_seccionamento(projeto) is None
    p = PendenciaItem.objects.get(
