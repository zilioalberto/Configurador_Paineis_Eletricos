...
from configurador.composicao_painel.services.sugestoes.orquestrador import (
...
def test_projeto_precisa_contatoras_motor_ou_resistencia_contator(criar_projeto):
    ...
    with patch(
        "configurador.composicao_painel.services.sugestoes.orquestrador.CargaMotor.objects.filter"
    ) as mock_cm, patch(
        "configurador.composicao_painel.services.sugestoes.orquestrador.CargaResistencia.objects.filter"
    ) as mock_cr, patch(
        "configurador.composicao_painel.services.sugestoes.orquestrador.CargaValvula.objects.filter"
    ) as mock_cv:
...
@pytest.mark.django_db
@patch("configurador.composicao_painel.services.sugestoes.orquestrador.montar_etapas_geracao")
@patch("configurador.composicao_painel.services.sugestoes.orquestrador.remover_sugestoes_ja_aprovadas")
@patch("configurador.composicao_painel.services.sugestoes.orquestrador.limpar_sugestoes_projeto")
...
@pytest.mark.django_db
@patch("configurador.composicao_painel.services.sugestoes.orquestrador.montar_etapas_geracao")
@patch("configurador.composicao_painel.services.sugestoes.orquestrador.sincronizar_pendencias_cargas_sem_regra_catalogo")
