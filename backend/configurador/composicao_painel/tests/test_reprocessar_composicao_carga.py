...
from configurador.cargas.models import Carga
from catalogo.models import Produto
from configurador.composicao_painel.models import ComposicaoItem, PendenciaItem, SugestaoItem
from configurador.composicao_painel.services.reprocessar_composicao_carga import (
...
def test_reprocessar_remove_aprovados_sugestoes_e_pendencias_da_carga(
    ...
    with (
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_disjuntor_motor_para_carga"
        ) as mock_d,
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_contatora_para_carga"
        ) as mock_c,
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_minidisjuntores_para_carga"
        ) as mock_md,
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_soft_starter_para_carga"
        ) as mock_ss,
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_inversores_frequencia_para_carga"
        ) as mock_if,
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_rele_estado_solido_para_carga"
        ),
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_rele_interface_para_carga"
        ),
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.reprocessar_bornes_para_carga"
        ),
        patch(
            "configurador.composicao_painel.services.reprocessar_composicao_carga.calcular_e_salvar_dimensionamento_basico"
        ),
    ):
