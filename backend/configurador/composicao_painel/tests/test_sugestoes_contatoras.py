...
from configurador.cargas.models import Carga, CargaResistencia, CargaValvula
...
def test_contatora_valvula_contator_quantidade_solenoides(criar_projeto):
    ...
    with patch(
        "configurador.composicao_painel.services.sugestoes.contatoras.selecionar_contatoras",
