...
from configurador.dimensionamento.models import DimensionamentoCircuitoCarga
from configurador.composicao_painel.models import PendenciaItem, SugestaoItem
from configurador.composicao_painel.services.sugestoes.executar_por_carga import (
