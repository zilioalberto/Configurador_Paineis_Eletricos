...
from configurador.dimensionamento.services import calcular_e_salvar_dimensionamento_basico

from configurador.composicao_painel.models import ComposicaoItem, SugestaoItem
from configurador.composicao_painel.services.sugestoes.seccionadoras import (
    gerar_sugestao_seccionamento,
)
from configurador.composicao_painel.services.sugestoes.contatoras import (
    gerar_sugestoes_contatoras,
)
from configurador.composicao_painel.services.sugestoes.disjuntores_motor import (
    gerar_sugestoes_disjuntores_motor,
)
from configurador.composicao_painel.services.sugestoes.rele_sobrecarga import (
    gerar_sugestoes_reles_sobrecarga,
)
from configurador.composicao_painel.services.sugestoes.fusivel import (
    gerar_sugestoes_fusiveis,
)
from configurador.composicao_painel.services.sugestoes.minidisjuntores import (
    gerar_sugestoes_minidisjuntores,
)
from configurador.composicao_painel.services.sugestoes.soft_starter import (
    gerar_sugestoes_soft_starters,
)
from configurador.composicao_painel.services.sugestoes.inversores_frequencia import (
    gerar_sugestoes_inversores_frequencia,
)
from configurador.composicao_painel.services.sugestoes.reles_estado_solido import (
    gerar_sugestoes_reles_estado_solido,
)
from configurador.composicao_painel.services.sugestoes.reles_interface import (
    gerar_sugestoes_reles_interface,
)
from configurador.composicao_painel.services.sugestoes.bornes import (
    gerar_sugestoes_bornes,
)
from configurador.composicao_painel.services.sugestoes.pendencias_sem_regra import (
    sincronizar_pendencias_cargas_sem_regra_catalogo,
)

from configurador.cargas.models import Carga, CargaMotor, CargaResistencia, CargaValvula
