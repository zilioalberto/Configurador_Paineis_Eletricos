...
INSTALLED_APPS = [
    ...
    'core',
    'catalogo',
    'configurador.projetos.apps.ProjetosConfig',
    'configurador.cargas.apps.CargasConfig',
    'configurador.dimensionamento.apps.DimensionamentoConfig',
    'configurador.selecao_componentes.apps.SelecaoComponentesConfig',
    'configurador.composicao_painel.apps.ComposicaoPainelConfig',
    'configurador.wizard.apps.WizardConfig',
    'documentos',
]
