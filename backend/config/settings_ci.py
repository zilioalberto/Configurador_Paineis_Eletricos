...
import config.settings as _django_settings  # noqa: E402
...
# Os migrations foram removidos para uma nova linha base. Nos testes, o Django
# cria as tabelas temporarias diretamente dos models, sem gerar arquivos novos.
MIGRATION_MODULES = {
    "accounts": None,
    "catalogo": None,
    "projetos": None,
    ...
    "selecao_componentes": None,
    "composicao_painel": None,
    "wizard": None,
    "tarefas": None,
    "cadastros": None,
    "orcamentos": None,
    "configuracoes_erp": None,
    "auditoria": None,
    "compras": None,
    "conformidade": None,
    "crm": None,
